...
from database.models import Gift, Banner, Bg, NameGift, Symbol, Admins
from database.orm_query import orm_create_banners, orm_create_name_gift, orm_create_sym, orm_create_bg, orm_create_admin
...
async def create_db():
    async with (engine.begin() as conn):
        ...
        await conn.run_sync(NameGift.metadata.create_all)
    ...
    async with session_maker() as session:
        ...
        await orm_create_name_gift(session)
